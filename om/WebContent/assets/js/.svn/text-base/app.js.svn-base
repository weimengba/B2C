...
$(document).ready(function() {
     ...
     * 添加分页事件。
     */
    $('.common-page-button').click(function(){    	
    	//设置表单的当前页。
    	$('.common-page-cur').val($(this).attr('data-cur'));
    	//提交表单。
    	$('.common-page-form').submit();
    });
    
    /**
     * 添加排序事件。
     */
    $('.common-order-button').click(function(){ 
    	//设置表单的当前页。
    	$('.common-page-order').val($(this).attr('data-order'));
    	$('.common-page-desc').val($(this).attr('data-desc'));	
    	//提交表单。
    	$('.common-page-form').submit();
    });
    
    if($('.common-page-form').length > 0){
    	//获取排序的字段
    	var order = $('.common-page-order').val();
    	//获取排序的顺序
    	var desc = $('.common-page-desc').val();
    	//设置排序
    	$(".common-order-button").each(function(){
     ...
     * 查询按钮事件
     */
    $('.common-page-form-search').click(function(){ 
    	//设置表单的当前页。
    	$('.common-page-order').val("");
    	$('.common-page-desc').val("");	
    	//提交表单。
    	$('.common-page-form').submit();
    });
