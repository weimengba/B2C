			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<c:if test="${object != null }"><i class="im-file3"></i>文件详情</c:if>
					</h1>
					<!-- Start .bredcrumb -->
					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-body">
								<form action="plat/common/fileSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="type" value="${object.type}" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">对象ID</label>
										<div class="col-lg-10">
											<input type="text" name="objectId" value="${object.object_id }" class="form-control">
										</div>	
									</div>									
									<div class="form-group">
										<label class="col-lg-2 control-label">文件名</label>
										<div class="col-lg-10" >
											<input type="text" name="fileName" value="${object.file_name }" class="form-control" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-10" >
											<c:if test="${object !=null }">
												<img src="${sys_image_prefix }${object.path }" >
											</c:if>	
											<%-- <input type="file" name="${object.type}" value="${object.file_name}"> --%>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">原文件名</label>
										<div class="col-lg-10">
											<input type="text" name="oldName" value="${object.old_name }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">内容类型</label>
										<div class="col-lg-10">
											<input type="text" name="contentType" value="${object.content_type}" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">文件长度</label>
										<div class="col-lg-10">
											<input type="text" name="length" value="${object.length }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">存储路径</label>
										<div class="col-lg-10">
											<input type="text" name="path" value="${object.path}" class="form-control">
										</div>
									</div>
							</div>
							<!-- End .form-group  -->
