					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="plat/goodsComment/goodsCommentList.do" method="get">
									  ...
									  <input class="common-page-order" type="hidden" name="c_od"	value="${param.c_od }">
										 ...
										 <label>评论星级：</label>
										 <input	type="text" name="star" value="${param.star }"> 
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="content" data-desc="">评论内容</th>
											<th class="common-order-button" data-order="goodsId" data-desc="">对应商品</th>
											<th class="common-order-button" data-order="customerId" data-desc="">评论者昵称</th>
											<th class="common-order-button" data-order="star" data-desc="">评论星级</th>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td class="center" width="12%"><a class="btn btn-primary btn-sm"
													href="plat/goodsComment/goodsCommentDelete.do?id=${d.id }">删除</a></td>
