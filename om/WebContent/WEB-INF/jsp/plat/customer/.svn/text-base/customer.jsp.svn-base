			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-checkbox-checked"></i> 添加客户
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加客户</c:if>
									<c:if test="${object != null }">编辑客户</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="plat/customer/customerSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nickname" value="${object.nickname }" class="form-control">
										</div>
									</div>
									<c:if test="${object == null }">
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="account" value="${object.account }" class="form-control">
										</div>	
									</div>									
									</c:if>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="password" value="${object.password }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">手机</label>
										<div class="col-lg-10">
											<input type="text" name="mobile" value="${object.mobile }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">邮箱</label>
										<div class="col-lg-10">
											<input type="text" name="email" value="${object.email }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-10">						
											...
											<input type="radio" name="sex" value="1" <c:if test="${object.sex == '1' }">checked</c:if>>男
									        <input type="radio" name="sex" value="2" <c:if test="${object.sex == '2' }">checked</c:if>>女
										</div>
									</div>
							</div>
							<!-- End .form-group  -->
