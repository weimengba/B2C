						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加地址</c:if>
									<c:if test="${object != null }">编辑地址</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="plat/customer/addressSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									<c:if test="${object != null }">
										<input type="hidden" name="id" value="${object.id }">																											
									</c:if>
									<input type="hidden" name="customerId" value="${customerId }">
									<div class="form-group">							    
										<label class="col-lg-2 control-label">收货姓名</label>
										<div class="col-lg-10">
											<input type="text" name="consignee" value="${object.consignee }" class="form-control">
										</div>	
									</div>	
									<div class="form-group">
										<label class="col-lg-2 control-label">收货电话</label>
										<div class="col-lg-10">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="postcodes" value="${object.postcodes }" class="form-control">
										</div>
									</div>				
							</div>
							<!-- End .form-group  -->
