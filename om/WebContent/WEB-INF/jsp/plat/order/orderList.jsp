					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="plat/order/orderList.do" method="get">
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="totalPrice" data-desc="">总价</th>
											<th class="common-order-button" data-order="pay" data-desc="">应付</th>
											<th class="common-order-button" data-order="state" data-desc="">订单状态</th>
											<th class="common-order-button" data-order="customerAddressId" data-desc="">用户地址ID</th>
											<th class="common-order-button" data-order="remark" data-desc="">用户评论</th>
