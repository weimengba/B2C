			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-checkbox-checked"></i> 订单管理
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加Order</c:if>
									<c:if test="${object != null }">编辑Order</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<c:if test="${object == null }">
									<form action="plat/order/orderSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
										<div class="form-group">
											<label class="col-lg-2 control-label">用户ID</label>
											<div class="col-lg-10">
												<input type="text" name="customerId" value="${object.customer_id }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">总价</label>
											<div class="col-lg-10">
												<input type="text" name="totalPrice" value="${object.total_price }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">应付</label>
											<div class="col-lg-10">
												<input type="text" name="pay" value="${object.pay }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">订单状态</label>
											<div class="col-lg-10">
												<input type="text" name="state" value="${object.state }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">用户地址ID</label>
											<div class="col-lg-10">
												<input type="text" name="customerAddressId" value="${object.customer_address_id }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">用户评论</label>
											<div class="col-lg-10">
												<input type="text" name="customerAddressId" value="${object.customer_address_id }" class="form-control">
											</div>
										</div>
								...
								<c:if test="${object != null }">
									<form action="plat/order/orderEdit.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
										<input type="hidden" name="id" value="${object.id }">
										<div class="form-group">
											<label class="col-lg-2 control-label">订单号</label>
											<div class="col-lg-10">
												<input type="text" disabled="true" name="id" value="${object.id }" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">用户ID</label>
