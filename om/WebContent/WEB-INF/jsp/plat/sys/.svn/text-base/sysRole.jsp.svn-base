			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-checkbox-checked"></i> 添加角色数据
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加角色</c:if>
									<c:if test="${object != null }">编辑角色</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="plat/sys/sysRoleSave.do" method="get" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="remark" value="${object.remark }" class="form-control">
										</div>
									</div>
