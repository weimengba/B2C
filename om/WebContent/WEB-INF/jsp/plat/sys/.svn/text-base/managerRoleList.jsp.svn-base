					...
					<div class="col-lg-12">
						...
						<div           class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="plat/sys/managerRoleList.do" method="get">
									...
									<label>管理员ID：</label><input type="text" name="managerId" value="${param.manager_id }">
									<label>角色ID：</label><input type="text" name="roleId" value="${param.role_id }">
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="manager_id" data-desc="">管理员ID</th>
											<th class="common-order-button" data-order="role_id" data-desc="">角色ID</th>
										</tr>
									</thead>
