		...
		<div class="content-wrapper">
			<div class="row">
				...
				<div class="col-lg-12 heading">
					...
					<c:if test="${object == null }"><i class="im-checkbox-checked"></i>添加权限</c:if>
		            <c:if test="${object != null }"><i class="im-checkbox-checked"></i>编辑权限</c:if>						
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加权限</c:if>
									<c:if test="${object != null }">编辑权限</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="plat/sys/sysPermissionSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="url" value="${object.url }" class="form-control">
										</div>
									</div>
							</div>
							<!-- End .form-group  -->
