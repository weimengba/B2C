					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="plat/sys/managerList.do" method="get">
									...
									<label>手机：</label><input type="text" name="mobile" value="${param.mobile }">
									<input type="submit" value="查询">
								</form>
								<a class="bike-add-button btn btn-primary btn-sm pull-right" href="plat/sys/sysManager.do">添加</a>
							</div>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.mobile }</td>
												<td>${d.email }</td>
												<td class="center" width="15%"><a class="btn btn-primary btn-sm" href="plat/sys/sysManager.do?id=${d.id }">编辑</a>|<a class="btn btn-primary btn-sm"
													href="plat/sys/deleteSysManager.do?id=${d.id }">删除</a>|<a class="btn btn-primary btn-sm" href="plat/sys/.do?id=${d.id }">添加角色</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
