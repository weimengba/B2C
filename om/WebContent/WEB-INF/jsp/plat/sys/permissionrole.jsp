		...
		<div class="content-wrapper">
			<div class="row">
				...
				<div class="col-lg-12 heading">
					...
					<c:if test="${object == null }"><i class="im-checkbox-checked"></i>角色ID</c:if>
		            <c:if test="${object != null }"><i class="im-checkbox-checked"></i>权限ID</c:if>						
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">角色ID</c:if>
									<c:if test="${object != null }">权限ID</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="plat/sys/permissionroleSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">

									<c:if test="${object != null }">
										<input type="hidden" name="id" value="${object.id }">
									</c:if>
									<div class="form-group">
										<label class="col-lg-2 control-label">角色ID</label>
										<div class="col-lg-10">
											<input type="text" name="roleId" value="${object.role_id }" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">权限ID</label>
										<div class="col-lg-10">
											<input type="text" name="permissionId" value="${object.permission_id }" class="form-control">
										</div>
									</div>
							</div>
							<!-- End .form-group  -->
