					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<h4 class="panel-title">Demo 表格</h4>
									...
									<tbody>
										<c:forEach items="${data }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.age }</td>
												<td>${d.money }</td>
												<td class="center" width="12%"><a class="btn btn-primary btn-sm" href="#">编辑</a>|<a class="btn btn-primary btn-sm" href="plat/common/delete.do?c_tb=demo&id=${d.id }">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
