			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-table2"></i> GoodsType表格
					</h1>
					<!-- Start .bredcrumb -->
					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="goods/goodsType.do" method="get">
								...
								<a class="bike-add-button btn btn-primary btn-sm pull-right" href="goods/getGoodsTypeId.do">添加</a>
							</div>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.ctime }</td>
												<td>${d.utime }</td>
												<td class="center" width="12%"><a class="btn btn-primary btn-sm" href="goods/getGoodsTypeId.do?id=${d.id }">编辑</a>|<a class="btn btn-primary btn-sm"
													href="goods/goodsTypeDelete.do?id=${d.id }">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
