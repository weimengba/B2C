			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-table2"></i> GoodsAttr表格
					</h1>
					<!-- Start .bredcrumb -->
					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="goods/goodsAttrList.do" method="get">
									...
									<label>可选择数据：</label>
									<input type="text" name="chooseValue" value="${param.chooseValue }">
									 <input type="submit" value="查询">
								</form>
								<a class="bike-add-button btn btn-primary btn-sm pull-right" href="goods/getGoodsAttrId.do">添加</a>
							</div>
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="typeId" data-desc="">类别ID</th>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.dataType }</td>
												<td>${d.chooseValue }</td>
												<td class="center" width="12%"><a class="btn btn-primary btn-sm" href="goods/getGoodsAttrId.do?id=${d.id }">编辑</a>|<a class="btn btn-primary btn-sm"
													href="goods/goodsAttrDelete.do?id=${d.id }">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
