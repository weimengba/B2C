			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-checkbox-checked"></i> 添加GoodsAttr数据
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加GoodsAttr</c:if>
									<c:if test="${object != null }">编辑GoodsAttr</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="goods/goodsAttrSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">类别ID：</label>
										<div class="col-lg-10">
