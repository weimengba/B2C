			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-checkbox-checked"></i> 添加GoodsType数据
					</h1>
					<!-- Start .bredcrumb -->
					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-body">
								<form action="goods/goodsTypeSave.do" method="post" class="form-horizontal group-border hover-stripped" role="form" id="validate">
