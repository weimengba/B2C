			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="fa-flag-checkered"></i> 平台用户列表。
					</h1>
					<!-- Start .bredcrumb -->
					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="xx/sysManagerList.do" method="get">
									...
									<label>姓名：</label><input type="text" name="name" value="${fn:trim(param.name) }">
									<label>手机：</label><input type="text" name="mobile" value="${fn:trim(param.mobile) }">
									<input type="submit" value="查询">
								</form>
								<a class="bike-add-button btn btn-primary btn-sm pull-right" href="xx/sysManager.do">添加</a>
							</div>
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="name" data-desc="">姓名</th>
											<th class="common-order-button" data-order="account" data-desc="">账号</th>
											<th class="common-order-button" data-order="mobile" data-desc="">手机</th>
											<th class="common-order-button" data-order="email" data-desc="">邮箱</th>
											<th>操作</th>
										</tr>
									</thead>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.mobile }</td>
												<td>${d.email }</td>
												<td class="center" width="12%"><a class="btn btn-primary btn-sm" href="xx/sysManager.do?id=${d.id }">编辑</a>|<a class="btn btn-primary btn-sm"
													href="xx/sysManagerDelete.do?id=${d.id }">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
