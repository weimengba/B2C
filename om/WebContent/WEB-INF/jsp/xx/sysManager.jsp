						...
						<div class="panel panel-default toggle">
							...
							<div class="panel-heading">
								...
								<h3 class="panel-title">
									<c:if test="${object == null }">添加SysManager</c:if>
									<c:if test="${object != null }">编辑SysManager</c:if>
								</h3>
							</div>
							<div class="panel-body">
								<form action="xx/sysManagerSave.do" enctype="multipart/form-data" method="post" class="form-horizontal group-border hover-stripped" role="form"
									id="validate">
