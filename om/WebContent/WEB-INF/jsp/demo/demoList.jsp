					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default plain toggle panelClose panelRefresh">
							...
							<div class="panel-heading white-bg">
								<form style="margin-top: 20px;" class="common-page-form" action="demo/demoList.do" method="get">
									<input class="common-page-cur" type="hidden" name="c_cur" value="1"> <input class="common-page-order" type="hidden" name="c_od"
										value="${param.c_od }"> <input class="common-page-desc" type="hidden" name="c_desc" value="${param.c_desc }"> <label>姓名：</label><input
										type="text" name="name" value="${param.name }"> <label>年龄：</label><input type="text" name="age" value="${param.age }"> <input
										type="submit" value="查询">
								</form>
								<a class="bike-add-button btn btn-primary btn-sm pull-right" href="demo/addDemo.do">添加</a>
							</div>
								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
											...
											<th class="common-order-button" data-order="age" data-desc="">年龄</th>
											<th class="common-order-button" data-order="school" data-desc="">余额</th>
									...
									<tbody>
										<c:forEach items="${data.list }" var="d">
											<tr class="odd gradeX">
												...
												<td>${d.age }</td>
												<td>${d.money }</td>
												<td class="center" width="12%"><a class="btn btn-primary btn-sm" href="#">编辑</a>|<a class="btn btn-primary btn-sm"
													href="plat/common/delete.do?c_tb=demo&id=${d.id }">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
