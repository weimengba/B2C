								...
								<table class="table display table-bordered table-hover table-striped table-condensed" id="datatable">
									<thead>
										<tr>
										    ...
										    <th class="common-order-button" data-order="customerId" data-desc="">用户ID</th>
											<th class="common-order-button" data-order="totalPrice" data-desc="">总格</th>
