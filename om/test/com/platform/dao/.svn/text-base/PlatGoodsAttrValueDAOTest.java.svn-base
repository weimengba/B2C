 ...
 *
 */
public class PlatGoodsAttrValueDAOTest {
	...
	public void testinsertAttrValue() {
		...
		param.put("attrId", 1);
		param.put("value", "法国");
		int num = PlatGoodsAttrValueDAO.insertAttrValue(param);
	...
	public void testselectGoodsAttrValue() {
		List<Map<String, Object>> list=PlatGoodsAttrValueDAO.selectGoodsAttrValue(MMUtil.getMM());
	...
	public void testupdateAttrValueById() {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("goods_id", 2);
		param.put("attr_id", 1);
		param.put("value", "白酒");
		param.put("id", 1);
		int num = PlatGoodsAttrValueDAO.updateAttrValueById(param);
		Assert.assertEquals(1, num);
	}
